...
SECTION_ORDER::[§1::PURPOSE, §2::PROTECTION_BYPASS_PATTERN, §3::CI_WORKFLOW_INTEGRATION, §4::GITHUB_ACTIONS_PATTERN, §5::PLAYWRIGHT_CONFIGURATION, §6::CHROME_DEVTOOLS_MCP_ACCESS, §7::SETUP_CHECKLIST, §8::SECURITY_CONSIDERATIONS, §9::TROUBLESHOOTING, §10::AGENT_INTEGRATION, §11::RELATED_SKILLS, §12::REFERENCES]

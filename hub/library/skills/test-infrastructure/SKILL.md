...
# test-infrastructure
SECTION_ORDER::[§1::PRIMARY_SOURCE_MANDATORY_FIRST, §2::DETAILED_DOCUMENTATION, §3::POC_REFERENCE_WHEN_NEEDED, §4::CORE_PATTERNS_POC_PROVEN, §5::DIRECTORY_STRUCTURE_THREE_TIER, §6::VITEST_CONFIGURATION, §7::COVERAGE_PHILOSOPHY_POC_PROVEN, §8::TURBOREPO_CONFIGURATION, §9::AGENT_CONSULTATION, §10::KNOWLEDGE_BASE_REFERENCES]

...
SECTION_ORDER::[§1::MANDATORY_PROTOCOL_ACTIVATION, §2::TODOWRITE_ENFORCEMENT, §3::CORE_ENFORCEMENT_PROTOCOLS, §4::SYSTEM_AWARENESS_MANDATE, §5::MINIMAL_INTERVENTION_PRINCIPLE, §6::TDD_DISCIPLINE, §7::VERIFICATION_PROTOCOLS, §8::DECISION_GATES, §9::INTEGRATION, §10::WISDOM_SYNTHESIS]

BUILD_MASTERY::[SYSTEM_AWARENESS+TDD_DISCIPLINE+MINIMAL_INTERVENTION+VERIFICATION_PROTOCOLS]->PRODUCTION_QUALITY

§1::MANDATORY_PROTOCOL_ACTIVATION

BEFORE_ANY_IMPLEMENTATION::[
  STEP_1::Read("~/.claude/skills/build-execution/tdd-discipline.oct.md")->MANDATORY[load_complete_workflow],
  STEP_2::Read("~/.claude/skills/build-execution/build-philosophy.oct.md")->MANDATORY[load_MIP_framework],
  STEP_3::Read("~/.claude/skills/build-execution/verification-protocols.oct.md")->MANDATORY[load_evidence_requirements],
  EVIDENCE::TodoWrite_must_show::"Protocol loaded: TDD + MIP + Verification"
]

DETAILED_GUIDANCE::[
  TDD_WORKFLOW::"See tdd-discipline.oct.md for RED-GREEN-REFACTOR examples and best practices",
  MIP_FRAMEWORK::"See build-philosophy.oct.md for system awareness principles and decision frameworks",
  VERIFICATION::"See verification-protocols.oct.md for evidence requirements and anti-validation-theater",
  ANTI_PATTERNS::"See anti-patterns.oct.md for detection triggers and prevention strategies",
  MCP_TOOLS::"See mcp-tools.oct.md for Context7 and Repomix integration during implementation"
]

§2::TODOWRITE_ENFORCEMENT
...
§3::CORE_ENFORCEMENT_PROTOCOLS

§4::SYSTEM_AWARENESS_MANDATE
...
§5::MINIMAL_INTERVENTION_PRINCIPLE
...
DETAILED_FRAMEWORK::"See build-philosophy.oct.md sections 2-4 for MIP process, simplification tests, and decision gates"
...
DETAILED_WORKFLOW::"See tdd-discipline.oct.md for complete RED-GREEN-REFACTOR examples, best practices, and anti-patterns"

§7::VERIFICATION_PROTOCOLS
...
DETAILED_REQUIREMENTS::"See verification-protocols.oct.md for complete evidence requirements and anti-validation-theater enforcement"
...
DETAILED_FRAMEWORKS::"See build-philosophy.oct.md sections 5-8 for complete decision frameworks with examples"

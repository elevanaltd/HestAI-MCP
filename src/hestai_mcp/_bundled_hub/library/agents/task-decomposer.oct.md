...
§1::IDENTITY
  ...
  PRINCIPLES::[
    ...
    "TDD Embedded: Each task = one RED-GREEN-REFACTOR cycle, never separate TEST and FEAT tasks",
  ...
  CONDUCT:
    ...
    PROTOCOL:
      MUST_ALWAYS::[
        ...
        "Embed TDD cycle within each task (TEST: failing then FEAT: implementation)",
      ...
      MUST_NEVER::[
        ...
        "Produce plans with more than 30 tasks (over-decomposition) or fewer than 10 (under-decomposition)",

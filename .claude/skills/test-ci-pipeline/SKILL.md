...
CI_PIPELINE::.hestai/test-context/CI-PIPELINE-CONFIGURATION.md→[turborepo_config, github_actions, quality_gates[typecheck→lint→test], secret_management, parallel_execution, artifact_storage]
...
DOCUMENTATION::[
  .hestai/test-context/CI-PIPELINE-CONFIGURATION.md
]

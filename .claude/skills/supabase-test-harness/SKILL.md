...
SUPABASE_HARNESS::.hestai/test-context/SUPABASE-TEST-HARNESS.md→[local_setup[docker/cli], test_user_creation[auth_admin_api], RLS_testing, seed_procedures, preview_branch_integration, env_config]
...
DOCUMENTATION::[
  .hestai/test-context/SUPABASE-TEST-HARNESS.md
]
